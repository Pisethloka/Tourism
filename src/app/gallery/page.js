        ...
        {filteredItems.map((item) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-brand-dark/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-[2px]">
              <span className="text-brand-gold text-xs sm:text-sm font-bold tracking-[0.25em] uppercase drop-shadow-md group-hover:scale-110 transition-transform duration-300">
                VIEW FULLSCREEN
              </span>
            </div>
          </div>
