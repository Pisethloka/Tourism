/**
 * Gallery.jsx - High-Resolution Visual Gallery Component
 * Provides category filtering (All Photos, Cultural, Food, Dark Tourism, Eco Tourism)
 * and a modal Lightbox viewer with keyboard arrow navigation and image counter.
 */
...
import foodLokLak from "../assets/food_lok_lak.jpg";
import foodKhmerPlatter from "../assets/food_khmer_platter.jpg";
import foodBaiSachChrouk from "../assets/food_bai_sach_chrouk.jpg";
import foodNumPang from "../assets/food_num_pang.jpg";
import foodNomBanhChok from "../assets/food_nom_banh_chok.jpg";
import darkKillingTree from "../assets/dark_killing_tree.jpg";
import darkTuolSlengCell from "../assets/dark_tuol_sleng_cell.jpg";
import darkTuolSlengBuilding from "../assets/dark_tuol_sleng_building.jpg";
import darkTuolSlengGallows from "../assets/dark_tuol_sleng_gallows.jpg";
import darkTuolSlengStupa from "../assets/dark_tuol_sleng_stupa.jpg";
import ecoIslandLagoon from "../assets/eco_island_lagoon.jpg";
import ecoJungleHuts from "../assets/eco_jungle_huts.jpg";
import ecoJungleRuins from "../assets/eco_jungle_ruins.jpg";
import ecoWaterfall from "../assets/eco_waterfall.jpg";
import ecoWaterbirds from "../assets/eco_waterbirds.jpg";
import ecoElephantsJungle from "../assets/eco_elephants_jungle.jpg";
import ecoYeakLaomLake from "../assets/eco_yeak_laom_lake.jpg";
import ecoIrrawaddyDolphin from "../assets/eco_irrawaddy_dolphin.jpg";
import ecoBatCave from "../assets/eco_bat_cave.jpg";
...
const galleryItems = [
  ...
  },
  {
    ...
    description:
      "Lush jungle waterfalls and ancient sacred riverbed carvings.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    description: "Serene smiling stone faces of Jayavarman VII at Bayon Temple.",
  },
  {
    id: 9,
    src: darkSkulls,
    ...
    description:
      "Poignant historical archive and memorial site in Phnom Penh.",
  },
  {
    id: 10,
    src: galleryFood3,
  ...
  },
  {
    ...
    description: "Tender stir-fried beef served with fresh salad, fried egg, and lime-pepper dip.",
  },
  {
    id: 12,
    ...
    description: "An authentic arrangement of fresh herbs, spring rolls, and grilled specialties in banana leaves.",
  },
  {
    id: 13,
    ...
    description: "Marinated grilled pork over jasmine rice served with sunny-side-up egg and fresh chili.",
  },
  {
    id: 14,
    src: foodNumPang,
    ...
    description: "Crispy crusty baguette filled with savory meats, pickled papaya, and fresh chili.",
  },
  {
    id: 15,
    src: foodNomBanhChok,
    ...
    description: "Traditional rice noodles topped with rich golden fish curry broth and fresh edible flowers.",
  },
  {
    id: 16,
    src: darkKillingTree,
    ...
    description: "Historic sacred memorial tree covered in colorful remembrance bracelets at the Killing Fields.",
  },
  {
    id: 17,
    ...
    description: "Preserved metal bed frame and shackles inside an original S-21 prison classroom cell.",
  },
  {
    id: 18,
    ...
    description: "Historic exterior balconies and barbed wire fencing of Security Prison 21 in Phnom Penh.",
  },
  {
    id: 19,
    ...
    description: "Original wooden gallows beam and water basins preserved in the S-21 memorial grounds.",
  },
  {
    id: 20,
    ...
    description: "White memorial stupa honoring victims inside the serene courtyard of Tuol Sleng Genocide Museum.",
  },
  {
    id: 21,
    src: ecoIslandLagoon,
    ...
    description: "Crystal clear emerald waters and tropical limestone cliffs along Koh Rong island.",
  },
  {
    id: 22,
    src: ecoJungleHuts,
    ...
    description: "Traditional wooden stilted eco-lodges surrounded by dense rainforest canopy.",
  },
  {
    id: 23,
    src: ecoJungleRuins,
    ...
    description: "Ancient mossy stone sanctuary ruins deeply submerged in wild Cardamom rainforest.",
  },
  {
    id: 24,
    src: ecoWaterfall,
    ...
    description: "Misty jungle waterfall plummeting into a sacred river basin surrounded by tropical trees.",
  },
  {
    id: 25,
    src: ecoWaterbirds,
    ...
    description: "Endangered spot-billed pelicans and painted storks taking flight over Tonle Sap lake.",
  },
  {
    id: 26,
    ...
    description: "Asian elephants walking freely through protected rainforest trails in Mondulkiri.",
  },
  {
    id: 27,
    src: ecoYeakLaomLake,
    ...
    description: "Pristine circular volcanic lake in Ratanakiri wrapped in sacred jungle and clear sunbeams.",
  },
  {
    id: 28,
    ...
    description: "Rare freshwater Irrawaddy dolphin swimming gracefully in the Mekong River near Kratie.",
  },
  {
    id: 29,
    src: ecoBatCave,
    ...
    description: "Millions of bats swarming out of Phnom Sampeau cliff caves at sunset into the evening sky.",
  },
  {
    id: 30,
    ...
    description: "Endless rolling green forest canopy spanning Cambodia's pristine Cardamom Mountains.",
  },
];

const categories = ["ALL PHOTOS", "CULTURAL", "FOOD", "DARK TOURISM", "ECO TOURISM"];
...
export const Gallery = () => {
  ...
  // Prevent background scrolling and enable keyboard navigation when Lightbox is active
  useEffect(() => {
    if (selectedImageIndex !== null) {
    ...
    <div className="pb-20 bg-brand-cream animate-fade-in">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-16 pb-4 relative animate-fade-in">
        <div className="relative flex items-center justify-center">
          ...
          {/* Center Text with Gold Diamond Flank */}
