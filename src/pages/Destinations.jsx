            ...
            <section id="dark-tourism" className="space-y-6">
              ...
              <div className="bg-transparent text-brand-dark border-l-4 border-red-800/80 pl-6 sm:pl-8 py-4 my-6 relative">
                <div className="flex items-start space-x-4 relative z-10">
                  <span className="font-serif text-4xl sm:text-5xl text-brand-gold-dark leading-none select-none shrink-0 mt-1">“</span>
                  <div className="space-y-3 font-sans">
                    <p className="text-sm sm:text-base text-brand-dark/90 font-light leading-relaxed italic">
                      Between 1975 and 1979, the totalitarian Khmer Rouge regime led by Pol Pot forced millions from Cambodian cities into rural agrarian labor camps, resulting in the tragic loss of an estimated 1.7 to 2 million lives. Today, memorial sites like Tuol Sleng (S-21) and Choeung Ek stand not for despair, but as sacred educational archives honoring memory, preserving historical truth, and celebrating the resilient rebirth of Cambodia. ”
                    </p>
                  </div>
                </div>
              </div>
